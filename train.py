...
#exp4
BEST_ALL_9 = {'normal': [('dil_conv_3x3', 0), ('avg_pool_3x3', 1), ('dil_conv_3x3', 0), ('dil_conv_3x3', 1), ('skip_connect', 2), ('dil_conv_5x5', 0), ('sep_conv_5x5', 1), ('avg_pool_3x3', 2), ('skip_connect', 3), ('sep_conv_3x3', 0), ('dil_conv_5x5', 1), ('conv_7x1_1x7', 2), ('sep_conv_3x3', 3), ('skip_connect', 4)], 'reduction': [('sep_conv_5x5', 0), ('sep_conv_3x3', 1), ('dil_conv_3x3', 0), ('skip_connect', 1), ('max_pool_3x3', 2), ('dil_conv_5x5', 0), ('dil_conv_3x3', 1), ('dil_conv_3x3', 2), ('conv_7x1_1x7', 3), ('dil_conv_5x5', 0), ('dil_conv_5x5', 1), ('sep_conv_7x7', 2), ('dil_conv_3x3', 3), ('sep_conv_7x7', 4)], 'normal_concat': [3, 5], 'reduction_concat': [2, 3]}
BEST_ALL_10 = {'normal': [('sep_conv_3x3', 0), ('sep_conv_3x3', 1), ('sep_conv_7x7', 0), ('max_pool_3x3', 1), ('max_pool_3x3', 2), ('sep_conv_5x5', 0), ('dil_conv_3x3', 1), ('max_pool_3x3', 2), ('skip_connect', 3), ('dil_conv_5x5', 0), ('sep_conv_3x3', 1), ('sep_conv_7x7', 2), ('skip_connect', 3), ('avg_pool_3x3', 4)], 'reduction': [('conv_7x1_1x7', 0), ('max_pool_3x3', 1), ('max_pool_3x3', 0), ('skip_connect', 1), ('sep_conv_5x5', 2), ('avg_pool_3x3', 0), ('max_pool_3x3', 1), ('sep_conv_7x7', 2), ('avg_pool_3x3', 3), ('avg_pool_3x3', 0), ('avg_pool_3x3', 1), ('skip_connect', 2), ('sep_conv_5x5', 3), ('sep_conv_3x3', 4)], 'normal_concat': [3, 5, 2, 2], 'reduction_concat': [2, 2, 4, 2]}
BEST_ALL_11 = {'normal': [('skip_connect', 0), ('max_pool_3x3', 1), ('conv_7x1_1x7', 0), ('dil_conv_3x3', 1), ('max_pool_3x3', 2), ('max_pool_3x3', 0), ('dil_conv_5x5', 1), ('sep_conv_7x7', 2), ('skip_connect', 3), ('skip_connect', 0), ('avg_pool_3x3', 1), ('max_pool_3x3', 2), ('max_pool_3x3', 3), ('skip_connect', 4)], 'reduction': [('avg_pool_3x3', 0), ('conv_7x1_1x7', 1), ('max_pool_3x3', 0), ('sep_conv_3x3', 1), ('sep_conv_7x7', 2), ('sep_conv_5x5', 0), ('sep_conv_7x7', 1), ('dil_conv_3x3', 2), ('dil_conv_5x5', 3), ('sep_conv_3x3', 0), ('skip_connect', 1), ('sep_conv_3x3', 2), ('max_pool_3x3', 3), ('conv_7x1_1x7', 4)], 'normal_concat': [3, 4, 5, 3], 'reduction_concat': [4, 4, 5, 5]}

#exp5
BEST_ALL_12 = {'normal': [('max_pool_3x3', 0), ('max_pool_3x3', 1), ('avg_pool_3x3', 0), ('dil_conv_3x3', 1), ('skip_connect', 2), ('skip_connect', 0), ('sep_conv_5x5', 1), ('skip_connect', 2), ('max_pool_3x3', 3), ('avg_pool_3x3', 0), ('sep_conv_7x7', 1), ('sep_conv_5x5', 2), ('dil_conv_5x5', 3), ('avg_pool_3x3', 4)], 'reduction': [('sep_conv_7x7', 0), ('dil_conv_3x3', 1), ('max_pool_3x3', 0), ('avg_pool_3x3', 1), ('sep_conv_3x3', 2), ('skip_connect', 0), ('dil_conv_3x3', 1), ('dil_conv_5x5', 2), ('dil_conv_3x3', 3), ('sep_conv_5x5', 0), ('conv_7x1_1x7', 1), ('sep_conv_5x5', 2), ('skip_connect', 3), ('conv_7x1_1x7', 4)], 'normal_concat': [5], 'reduction_concat': [3]}
BEST_ALL_13 = {'normal': [('sep_conv_3x3', 0), ('avg_pool_3x3', 1), ('sep_conv_5x5', 0), ('skip_connect', 1), ('dil_conv_5x5', 2), ('max_pool_3x3', 0), ('avg_pool_3x3', 1), ('dil_conv_3x3', 2), ('sep_conv_5x5', 3), ('avg_pool_3x3', 0), ('sep_conv_5x5', 1), ('max_pool_3x3', 2), ('max_pool_3x3', 3), ('max_pool_3x3', 4)], 'reduction': [('skip_connect', 0), ('conv_7x1_1x7', 1), ('conv_7x1_1x7', 0), ('dil_conv_3x3', 1), ('sep_conv_7x7', 2), ('avg_pool_3x3', 0), ('sep_conv_5x5', 1), ('sep_conv_7x7', 2), ('conv_7x1_1x7', 3), ('dil_conv_3x3', 0), ('avg_pool_3x3', 1), ('avg_pool_3x3', 2), ('sep_conv_5x5', 3), ('dil_conv_5x5', 4)], 'normal_concat': [4, 4, 3], 'reduction_concat': [5, 2, 3]}
BEST_ALL_14 = {'normal': [('avg_pool_3x3', 0), ('sep_conv_3x3', 1), ('sep_conv_3x3', 0), ('dil_conv_3x3', 1), ('avg_pool_3x3', 2), ('sep_conv_3x3', 0), ('max_pool_3x3', 1), ('sep_conv_3x3', 2), ('dil_conv_3x3', 3), ('sep_conv_3x3', 0), ('dil_conv_5x5', 1), ('dil_conv_5x5', 2), ('max_pool_3x3', 3), ('skip_connect', 4)], 'reduction': [('avg_pool_3x3', 0), ('sep_conv_3x3', 1), ('conv_7x1_1x7', 0), ('conv_7x1_1x7', 1), ('sep_conv_3x3', 2), ('dil_conv_3x3', 0), ('dil_conv_5x5', 1), ('skip_connect', 2), ('skip_connect', 3), ('sep_conv_7x7', 0), ('dil_conv_3x3', 1), ('dil_conv_5x5', 2), ('skip_connect', 3), ('max_pool_3x3', 4)], 'normal_concat': [2, 2, 4], 'reduction_concat': [3, 3, 3]}
BEST_ALL_15 = {'normal': [('max_pool_3x3', 0), ('sep_conv_7x7', 1), ('sep_conv_5x5', 0), ('max_pool_3x3', 1), ('dil_conv_5x5', 2), ('sep_conv_3x3', 0), ('skip_connect', 1), ('max_pool_3x3', 2), ('sep_conv_7x7', 3), ('max_pool_3x3', 0), ('sep_conv_7x7', 1), ('sep_conv_7x7', 2), ('sep_conv_3x3', 3), ('max_pool_3x3', 4)], 'reduction': [('conv_7x1_1x7', 0), ('sep_conv_3x3', 1), ('sep_conv_3x3', 0), ('max_pool_3x3', 1), ('sep_conv_3x3', 2), ('sep_conv_3x3', 0), ('avg_pool_3x3', 1), ('skip_connect', 2), ('max_pool_3x3', 3), ('conv_7x1_1x7', 0), ('dil_conv_5x5', 1), ('dil_conv_5x5', 2), ('sep_conv_7x7', 3), ('sep_conv_5x5', 4)], 'normal_concat': [5, 3, 2, 4], 'reduction_concat': [5, 5, 4, 2]}
...
def main(args):
    ...
    if args.arch_type == 'advrush':
        ...
        archs = BEST_ALL_8
    elif args.arch_type == 'best9':
        archs = BEST_ALL_9
    elif args.arch_type == 'best10':
        archs = BEST_ALL_10
    elif args.arch_type == 'best11':
        archs = BEST_ALL_11
    elif args.arch_type == 'best12':
        archs = BEST_ALL_12
    elif args.arch_type == 'best13':
        archs = BEST_ALL_13
    elif args.arch_type == 'best14':
        archs = BEST_ALL_14
    elif args.arch_type == 'best15':
        archs = BEST_ALL_15
